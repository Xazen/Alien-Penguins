...
public class UIControllerScript : MonoBehaviour {
	...
	void Update () {
			...
			AstronautsNumber = GameObject.FindGameObjectsWithTag("Human").Length;
		...
		if(AstronautsNumber>AddLayer2){
			Source2.mute=false;
		}
		if(AstronautsNumber>AddLayer3){
			Source3.mute=false;
		}
		if(AstronautsNumber>AddLayer4){
			Source4.mute=false;
		}
		if(AstronautsNumber>AddLayer5){
			Source5.mute=false;
		}
		if(AstronautsNumber>AddLayer6){
			Source6.mute=false;
		}
		if(AstronautsNumber>AddLayer7){
			Source7.mute=false;
		}
		if(AstronautsNumber>AddLayer8){
			Source8.mute=false;
		}
	}
}
